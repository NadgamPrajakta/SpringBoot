package EmployeeDetails.Employee.Controller;
...
import EmployeeDetails.Employee.DTO.EmployeeDto;
import EmployeeDetails.Employee.Entity.Employeee;
...
public class EmployeeeController {
	...
	List<Employeee> uss=new ArrayList<Employeee>();
	
	
	
	@PostMapping("/add-employee")
    public Employeee addemployee(@RequestBody Employeee employee)
    {
